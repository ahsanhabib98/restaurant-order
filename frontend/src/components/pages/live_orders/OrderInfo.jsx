...
export default class OrderInfo extends Component {
  ...
  increseMin = (e) => {
    ...
    this.setState({ prepTime: this.props.prepTime + 1 });

    // console.log("Increase: ", this.props.prepTime);
  };

  decreseMin = (e) => {
    e.preventDefault();

    if (this.props.prepTime > 0) {
      this.setState({ prepTime: this.props.prepTime - 1 });
    } else {
      alert("You should set prep time avobe 0");
    }

    // console.log("Decrease: ", this.props.prepTime);
  };

  // componentDidMount() {
  //   if (this.props.orderID) {
  //     axios
  //       .get(`${orderURL}/${this.props.orderID}/?subdomain=all`)
  //       .then((res) => {
  //         this.setState({
  //           ...this.state,
  //           order: res.data,
  ...
  // }
  getOrderItems = () => {
    return this.props.order?.order_items ? this.props.order?.order_items : [];
  };
  quantity = () => {
        ...
        <>
          <div className="outer-tab-content">
            ...
            <div className="tab-body">
                ...
                <div className="col">
                  <div className="inner-content">
                    <div className="order-details-info">
                      ...
                      <h6 className="">{order.brand_name}</h6>
                    </div>
                    <div className="order-details-info">
                      <p className="label">Order type</p>
                      <h6 className="">
                        {/* <FontAwesomeIcon icon={faTruck} size="sm" /> */}
                        {this.props.orderStatusName[order.order_status]}
                      </h6>
                    </div>
                    <div className="order-details-info">
                    ...
                    {/* <div className="order-details-info">
                      ...
                      <h6 className="">{order.payment_method}</h6>
                    </div> */}
                    {order.customer_address ? (
                      <div className="order-details-info">
                        <p className="label">Delivery to</p>
                        <h6 className="">{`${order.customer_address.address}, ${order.customer_address.city}`}</h6>
                ...
                <div className="col">
                  <div className="inner-content">
                    <div className="order-details-info">
                      ...
                      <h6 className="">{order.location_name}</h6>
                    </div>
                    ...
                    <div className="order-details-info">
                      ...
                      <h6 className="">{order.customer_phone}</h6>
                    </div>
                    <div className="order-details-info">
              ...
              {this.getOrderItems().map((order_item, idx) => {
                return (
                  <div
                    key={"order-info-" + idx}
                    className="order-item d-flex justify-content-between border-top border-bottom py-2"
                  >
          ...
          >
            <form action="" className="accept-order-form p-3">
