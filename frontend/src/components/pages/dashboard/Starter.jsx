...
class Starter extends Component {
  ...
  //   if (
  //     nextProps.company_id &&
  //     nextProps.company_id !== this.props.company_id
  //   ) {
  //     this.props.companyDetailsAction(nextProps.company_id);
  //   }
  //   if (nextProps.company) {
  //       this.props.companyDetailsAction();
  //   }
  // }
  handleSelectBranding(id) {
    this.props.brandingDetailsAction(id);
  }
  // componentDidMount() {
        ...
        <div className="row on-gutter-30px">
          <div className="col-xl-6">
            ...
            <div className="card p-2 card-sky mt-4 mb-3">
              <div className="row ">
                ...
                <div className="col dashboard-card-body pl-0">
                  ...
                  <p>
                    Answer Link few questions so our team can give you Link
                    better onboarding experience.
                  </p>
                  <Link to="" className="dasboard-card-body-link">
                    Start answering
                  </Link>
                </div>
              </div>
            ...
            <h4 className="onboarding-steps__subtitle">
              Follow these steps below to get your account ready to receive
              orders.
            </h4>
            ...
            <ol className="onboarding-steps__list">
              <li data-test="step-1">
                ...
                <p>
                  Add your outlets and configure their opening hours, payment
                  methods, delivery areas, and operation settings.
                </p>
                <Link
                  to="/outlets"
              ...
              <li data-test="step-2">
                <h2>Ordering menu</h2>
                <p>
                  Build your menu for customers to start placing their orders
                  from you.
                </p>
                <Link
                  to="/items_modifiers"
              ...
              <li data-test="step-3">
                ...
                <p>
                  Allow customers to place their orders on different touch
                  points such as your website, Instagram, Facebook, Google My
                  Business and more!
                </p>
                <Link
                  to="/sales_channel"
            ...
            <h6 className="end-text-h6">
              After completing all the steps, your business will be ready to
...
const mapStateToProps = (state) => {
  console.log(state.company, "demo");
  return {
